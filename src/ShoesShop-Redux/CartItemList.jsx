    ...
    return (
      <div className="product__table w-full ">
        <div className="heading w-full flex items-center uppercase text-center fw-semibold text-base text-white bg-sky-500">
          ...
          <div className="px-3 w-3/12">quantity</div>
          <div className="px-3 w-2/12">total</div>
        </div>
        <div className="body">
          {/* <div className="px-3 w-1/12">
            <span className="item__order text-lg block mx-auto">1</span>
          </div>
          ...
          <div className="px-3 w-3/12">
            <div className="quantity-adjust flex items-center justify-center gap-1">
              <div
                ...
                onClick={() => {
                  this.props.handleDecreaseCartItem();
                }}
              >
              ...
              <div
                ...
                onClick={() => {
                  this.props.handleIncreaseCartItem();
                }}
              >
          ...
          <div className="px-3 w-1/12">total</div> */}
          {this.props.cart.map((cartItem, idx) => {
            return (
              ...
              >
                ...
                <div className="px-3 w-2/12 text-center">
